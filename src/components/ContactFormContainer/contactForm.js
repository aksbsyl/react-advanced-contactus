          ...
          <Contact.Column>
            <div class="row">
              <div class="col-12">
                <Contact.Header>
                  <Contact.Title>
                    Nepal Academy Guidance and Counselling
                  </Contact.Title>
                  <Contact.Link>
                    Nepal Academy premises has Guidance and Counseling services
                    under Nepal Academy Counselling Cell. We encourage Students
                    to use the counseling opportunity to learn more about
                    themselves, to be happy and more productive. We support
